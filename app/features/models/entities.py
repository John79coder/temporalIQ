...
class UserAISettings(db.Model, TimestampMixin):
    ...
    # All defaults changed to True and 'global'
    use_llm_mapping = db.Column(db.Boolean, default=True, server_default='true')
    use_learned_detector = db.Column(db.Boolean, default=True, server_default='true')
    use_spacy_heuristics = db.Column(db.Boolean, default=True, server_default='true')
    use_embedding_similarity = db.Column(db.Boolean, default=True, server_default='true')
    use_ml_prioritization = db.Column(db.Boolean, default=True, server_default='true')
    use_nlp_urgency = db.Column(db.Boolean, default=True, server_default='true')
    use_rl_optimization = db.Column(db.Boolean, default=True, server_default='true')
    urgency_learning_scope = db.Column(db.String, default='global', server_default='global')
    duration_learning_scope = db.Column(db.String, default='global', server_default='global')
    mapping_learning_scope = db.Column(db.String, default='global', server_default='global')
    slot_ranking_learning_scope = db.Column(db.String, default='global', server_default='global')
    use_nlp_scoring = db.Column(db.Boolean, default=True, server_default='true')
    use_ai_page_extraction = db.Column(db.Boolean, default=True, server_default='true')
    __table_args__ = (
    ...
    def from_dict(data: dict) -> 'UserAISettings':
        ...
        settings.urgency_learning_scope = data.get("urgency_learning_scope", 'global')
        settings.duration_learning_scope = data.get("duration_learning_scope", 'global')
        settings.mapping_learning_scope = data.get("mapping_learning_scope", 'global')
        settings.slot_ranking_learning_scope = data.get("slot_ranking_learning_scope", 'global')
