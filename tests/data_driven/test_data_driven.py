...
def test_mapping_engine_conflicting_field_inputs(test_user, inputs, db_session, expected, caching_service, user_preference_service, features_service, ai_data_service, logging_service, preferences_service):
    ...
    engine = NotionDatabaseEngine(caching_service, SchemaParser(), detector_aggregator, CandidateGenerator(caching_service, TaskCandidateBuilder(preferences_service)), features_service)
